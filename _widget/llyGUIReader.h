...
//重载版本，给控件增加触摸回调
void setButtonFast(cocos2d::ui::Widget** widget, cocos2d::ui::Widget* father, cocos2d::ui::Widget::ccWidgetTouchCallback callback, char* childname);

//重载版本，给控件增加触摸回调，不需要给控件声明一个指针控制它
void setButtonFast(cocos2d::ui::Widget* father, cocos2d::ui::Widget::ccWidgetTouchCallback callback, char* childname);
...
//如果出错则会打断
cocos2d::ui::Widget* getChildWidget(cocos2d::ui::Widget* father, char* childname);
